...
# coords_lda, lda = run_lda_3d(B, labels)
# coords_jittered = coords_lda + np.random.normal(scale=60, size=coords_lda.shape)
# plot_lda_space_origin_axes_2d(coords_jittered, model_names, labels)
